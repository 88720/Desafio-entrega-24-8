...
function buscar() {
  let busc = document.getElementById("busc1").value;
...
function socio() {
  ...
  if (socio == "si") {
    ...
    document.getElementById("contacto").innerHTML =
      "<div>Genial! Danos un teléfono para comunicarnos con vos</div> <input id= contacto1 placeholder=Teléfono de contacto:  type=number></input><input Type=button Value=confirmar onClick=return ()></input>";
    let contacto = document.getElementById("contacto1").value;
    document.getElementById("pregunta").innerHTML =
      "Tenemos una a ctividad para vos, marca 1 para ver listado completo o 2 para buscar";
    //este console log simula el envío a una base de datos privada
    console.log("Llamar para asociar a : " + contacto);
  }
}
